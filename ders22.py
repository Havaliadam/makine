...
mse=mt.mean_squared_error(y_test,dttahmin,squared=False)


print(" KARAR AĞACI R2:{}  KARAR AĞACI MSE:{}".format(r2,mse))
...
mse2=mt.mean_squared_error(y_test,bgtahmin,squared=False)



print(" Bagging R2:{}  Bagging MSE:{}".format(r22,mse2))
